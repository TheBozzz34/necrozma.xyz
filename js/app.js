...
const audio = new Audio('music/The Wanderer (Fallout 4) (8 Bit Cover) [Tribute to Dion] - 8 Bit Universe.mp3');

document.getElementById('profile-picture').addEventListener('click', () => {
  document.getElementById('toast').classList.add('show');
  audio.play().then(r => { return }/*document.getElementById('profile-picture').classList.add('spin')*/);
});
